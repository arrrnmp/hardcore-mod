...
import com.hardcode.client.ui.HudSprites
 ...
 * [com.hardcode.common.model.StatsSnapshot] broadcasts. Direction is an 8-way Unicode
...
object StatsHud {
    ...
    private fun cardHeight(stat: com.hardcode.common.model.PlayerStat): Int {
    ...
    private fun showsAir(stat: com.hardcode.common.model.PlayerStat): Boolean =
        stat.maxAir > 0 && stat.air < stat.maxAir

    private fun hasAbsorptionOrAir(stat: com.hardcode.common.model.PlayerStat): Boolean {
        val (_, absorption) = heartSlots(stat)
        return absorption > 0 || showsAir(stat)
    }

    /** Normal + absorption slot counts. */
    private fun heartSlots(stat: com.hardcode.common.model.PlayerStat): Pair<Int, Int> {
    ...
    private fun heartRowCount(stat: com.hardcode.common.model.PlayerStat): Int {
